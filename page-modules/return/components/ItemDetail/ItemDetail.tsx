...
import { TabStatusDisplayName } from 'page-modules/return/config/config'
import { Return } from 'page-modules/return/type/return'
    ...
    return (
        <Card mt={4}>
            <Flex p={4} flexDir="column" gap="4">
                ...
                {/* <Flex flexDir="row" justify="space-between" px={4}>
                    <Box fontSize="sm">
                        <Text fontWeight="bold" as="span">
                            Refund Mode:
                        </Text>
                    ...
                    <Flex direction={'column'}>
                        {beneficiaryDetails.map((detail) => (
                            <Flex dir={'row'} key={detail.code} fontSize="sm" gap={1}>
                                <Text fontWeight="bold" as="span">
                                    {detail.displayName}:
                                </Text>
                                <TextWithTooltip text={detail.value} maxWidth={'10rem'} />
                            </Flex>
                        ))}
                    </Flex>
                </Flex> */}
